...
window.DESCENT_SPRITES = {
  ...
  /* sea sparkle — bioluminescent surf: a scatter of cold blue-white specks (plus a
     couple of brighter glints) twinkling out of step over a soft underglow, so the
     light reads as part of the water. No painted foam line — that fought the canvas's
     own moving foam; instead it sits low IN the real wash (yb in descent-engine) and
     blends with the moving surf rather than riding on top. Anchors the night/summer
     `sea-sparkle` egg (the engine adds a cool glow); the dots pulse on three staggered
     cycles, and hold steady for reduced motion. */
  'sea-sparkle': '<svg viewBox="0 0 120 44"><style>.dsp-a{animation:dspTwk 1.8s ease-in-out infinite}.dsp-b{animation:dspTwk 2.4s ease-in-out infinite;animation-delay:-.6s}.dsp-c{animation:dspTwk 1.4s ease-in-out infinite;animation-delay:-.9s}@keyframes dspTwk{0%,100%{opacity:.35}50%{opacity:1}}@media (prefers-reduced-motion:reduce){.dsp-a,.dsp-b,.dsp-c{animation:none;opacity:.8}}</style><g fill="#7fe6ff" opacity=".1"><ellipse cx="42" cy="22" rx="36" ry="9"/><ellipse cx="86" cy="23" rx="30" ry="8"/></g><g fill="#cffaff"><circle class="dsp-a" cx="12" cy="20" r="2.4"/><circle class="dsp-b" cx="24" cy="15" r="1.7" fill="#9fe9ff"/><circle class="dsp-c" cx="34" cy="24" r="2.6"/><circle class="dsp-a" cx="44" cy="28" r="1.6" fill="#bff3ff"/><circle class="dsp-b" cx="54" cy="19" r="2.2" fill="#9fe9ff"/><circle class="dsp-c" cx="64" cy="26" r="1.7"/><circle class="dsp-a" cx="74" cy="22" r="2.4" fill="#bff3ff"/><circle class="dsp-b" cx="84" cy="16" r="1.6" fill="#9fe9ff"/><circle class="dsp-c" cx="94" cy="27" r="2"/><circle class="dsp-a" cx="104" cy="21" r="2.3" fill="#bff3ff"/><circle class="dsp-b" cx="18" cy="29" r="1.5" fill="#9fe9ff"/><circle class="dsp-c" cx="48" cy="13" r="1.6" fill="#bff3ff"/><circle class="dsp-a" cx="70" cy="31" r="1.5" fill="#9fe9ff"/><circle class="dsp-b" cx="100" cy="30" r="1.7"/><circle class="dsp-c" cx="112" cy="18" r="1.8" fill="#9fe9ff"/></g><g fill="#eaffff"><path class="dsp-b" d="M58 18 L59 21 L62 22 L59 23 L58 26 L57 23 L54 22 L57 21 Z"/><path class="dsp-c" d="M90 16.6 L90.9 19.1 L93.4 20 L90.9 20.9 L90 23.4 L89.1 20.9 L86.6 20 L89.1 19.1 Z"/></g></svg>',
  ...
  /* STORM WYVERN — a dark, storm-lit dragon banking up-left: a beefy body on broad
     membranous bat wings, a horned head with an ember eye and a fire-lit maw, a
     barbed spade tail, and a lightning bolt overhead. (Egg id `storm-wyvern`.) */
  'storm-wyvern': '<svg viewBox="0 0 130 90"><polyline points="100,6 90,30 102,30 92,52" fill="none" stroke="#ffe27a" stroke-width="2.6" stroke-linejoin="round" stroke-linecap="round" opacity=".95"/><g fill="#19212f" stroke="#8fc4ff" stroke-width="1.6" stroke-linejoin="round" stroke-linecap="round"><path d="M66 56 Q90 58 108 50 L120 54 L107 60 L117 68 Q98 66 84 64 Q74 62 66 62 Z"/><path d="M62 50 Q72 28 96 20 Q88 36 100 38 Q86 42 92 52 Q76 48 62 54 Z" fill="#151c2a" stroke="#6f9ece"/><path d="M40 50 Q52 38 68 44 Q80 50 72 64 Q56 70 44 63 Q35 57 40 50 Z"/><path d="M62 62 Q66 72 62 78 L58 73 M62 78 L67 80 M62 78 L58 82" fill="none"/><path d="M44 50 Q33 42 22 31 Q16 25 11 28 Q9 24 11 22 L18 23 Q26 30 35 37 Q44 44 50 49 Z"/><path d="M56 48 Q66 24 90 14 Q80 34 94 36 Q78 42 86 54 Q70 49 56 54 Z" fill="#232d44"/></g><path d="M16 28 L22 17 L23 28 Z M21 27 L27 18 L27 28 Z" fill="#19212f" stroke="#8fc4ff" stroke-width="1.3" stroke-linejoin="round"/><circle cx="11" cy="25" r="2.2" fill="#ffb45a"/><circle cx="9" cy="24" r="2.6" fill="#ff9b46" opacity=".5"/></svg>',
